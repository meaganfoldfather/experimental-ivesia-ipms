...
ggsave(survival_traceplot, filename = "figs/supp-figXX-survival-model-traceplot.png", width = 10, height = 12, units = "in")

#### Growth model traceplot
growth_traceplot <- traceplot(growth_model)
ggsave(growth_traceplot, filename = "figs/supp-figXX-growth-model-traceplot.png", width = 10, height = 12, units = "in")

#### Establishment model
establishment_traceplot <- traceplot(establishment_model, n_pars = 15)
ggsave(establishment_traceplot, filename = "figs/supp-figXX-establishment-model-traceplot.png", width = 10, height = 8, units = "in")
